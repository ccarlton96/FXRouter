...
#ifndef FXROUTER_SWIFT_H
#define FXROUTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FXRouter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8FXRouter11AppDelegate")
...
@class NSMenu;
SWIFT_CLASS("_TtC8FXRouter17MenuBarController")
